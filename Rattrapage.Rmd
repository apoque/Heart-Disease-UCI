...
<br/>
On retire certaines variables qui n'ont à priori que très peu d'interêt selon nos observations précédentes, afin d'alléger la visualisation.
<br/>
```{r, warning=FALSE, message=FALSE, echo=FALSE}
...
as.factor(tmpBis$ecg.reg) ->tmpBis$ecg.reg
